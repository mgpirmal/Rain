...
var queryURL = "s://api.openweathermap.org/data/2.5/weather?q="+search+"&units=imperial&appid=d4498fe291ca2967ed4812e5f7191859";
...
function call(){
  var search = document.getElementById("input").value;
  var queryURL = "https://api.openweathermap.org/data/2.5/weather?q="+search+"&units=imperial&appid=d4498fe291ca2967ed4812e5f7191859";
console.log(search);
  $.ajax({
    url: queryURL,
    method: "GET"
...
// ==================================================================================
var query2URL = "https://api.openweathermap.org/data/2.5/forecast?q="+search+"&units=imperial&appid=d4498fe291ca2967ed4812e5f7191859";
$.ajax({
  url: query2URL,
  method: "GET"
})
